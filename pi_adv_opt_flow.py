...
file to keep everything nice and organized. This file should be closed from 
the controller.
'''
...
class App:
    def __init__(self, video_src=None, make_file=False, plot_graphs=False,
    ...
    def rect_coordinates(self, reduction):
    ...
    def set_rect_coors(self, reduction):
        rect_coords = self.rect_coordinates(reduction)
    ...
    def setup(self):
        ...
        self.height, self.width,= (480, 640)
        self.set_rect_coors(self.reduction)
    ...
    def run(self):
        ...
        for image in camera.capture_continuous(rawCapture, format="bgr",
            ...
            ''' 
            Check for items in queue. Empties once it is printed that 
            there is an object
            '''
